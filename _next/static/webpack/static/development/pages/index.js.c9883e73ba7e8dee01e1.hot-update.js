...
var Individual = function Individual(link, imgMock, imgPlain, imgAlt, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    src: imgMock,
    alt: imgAlt,
    className: "absolute top-0 left-auto z-0 hidden w-64 h-auto mt-2 md:inline md:self-end md:mt-0",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
