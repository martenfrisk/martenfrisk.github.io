...
var Projects = function Projects() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
    ...
    alt: "Handbook Search screenshot",
    className: "inline w-full h-auto mt-2 border-2 border-blue-300 rounded-sm md:hidden md:self-end md:mt-0",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42,
