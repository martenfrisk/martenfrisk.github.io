...
var Individual = function Individual(link, imgMock, imgPlain, imgAlt, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    className: "relative z-0 flex self-end justify-center w-full h-auto md:w-full md:justify-start",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17,
