...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    src: imgPlain,
    alt: altText,
    className: "inline w-1/2 h-auto mt-2 border-2 border-blue-300 rounded-md md:hidden md:self-end md:mt-0",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
