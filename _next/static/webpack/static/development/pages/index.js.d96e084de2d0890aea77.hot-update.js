...
var Individual = function Individual(link, imgMock, imgPlain, imgAlt, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    src: imgMock,
    alt: imgAlt,
    className: "absolute hidden w-full h-auto mt-2 md:inline md:self-end md:mt-0",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
