...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    className: "flex flex-col-reverse flex-wrap rounded-md items-center my-4 pb-6 pt-4  px-6 w-full ".concat(imgLeft ? 'md:flex-row bg-gray-100 hover:bg-blue-100' : 'md:flex-row-reverse bg-gray-300 hover:bg-blue-300'),
    __self: _this,
    __source: {
