...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    src: imgMock,
    alt: altText,
    className: "inline-block w-2/3 h-auto mt-2 rounded-md md:hidden",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
