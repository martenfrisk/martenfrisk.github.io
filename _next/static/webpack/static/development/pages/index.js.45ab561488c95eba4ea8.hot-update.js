...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    className: "w-1/5 h-auto md:w-full",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16,
    ...
    className: "self-end w-4/5 text-justify md:mb-20 md:w-3/4",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
