...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    className: "flex flex-wrap my-4 border-b border-blue-700 pb-6 md:border-white ".concat(!imgLeft ? 'flex-row-reverse bg-gray-500' : 'flex-row bg-gray-300'),
    __self: _this,
    __source: {
