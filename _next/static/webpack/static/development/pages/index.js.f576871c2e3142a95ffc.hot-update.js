...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    className: "flex flex-wrap items-center my-4 border-b border-blue-700 p-6 w-full md:border-white ".concat(!imgLeft ? 'flex-row-reverse bg-gray-500 text-right' : 'flex-row bg-gray-300 text-left'),
    __self: _this,
    __source: {
