...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    src: imgPlain,
    alt: altText,
    className: "".concat(imgLeft ? 'left-0' : 'right-0', "  w-auto h-64 mt-2 inline md:self-end md:mt-0"),
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
