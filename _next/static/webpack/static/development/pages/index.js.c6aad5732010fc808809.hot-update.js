...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    className: "flex flex-wrap items-stretch my-4 justify-evenly border-b border-blue-700 pb-10 md:border-white ".concat(!imgLeft && 'flex-row-reverse'),
    __self: _this,
    __source: {
