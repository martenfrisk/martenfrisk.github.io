...
var Individual = function Individual(link, imgMock, imgPlain, imgAlt, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    src: imgMock,
    alt: imgAlt,
    className: "absolute top-0 left-0 z-0 hidden w-auto h-64 mt-2 md:inline md:self-end md:-mt-40 ",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
