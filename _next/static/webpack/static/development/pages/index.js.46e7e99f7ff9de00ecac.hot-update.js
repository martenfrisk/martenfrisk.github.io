...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    className: "text-2xl font-semibold mt-4 md:mt-8 text-center cursor-pointer md:text-left hover:underline",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28,
