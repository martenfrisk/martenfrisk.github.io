...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    className: "flex flex-wrap rounded-md items-center my-4  px-6 w-full ".concat(imgLeft ? 'flex-row bg-gray-100' : 'flex-row-reverse bg-gray-300'),
    __self: _this,
    __source: {
