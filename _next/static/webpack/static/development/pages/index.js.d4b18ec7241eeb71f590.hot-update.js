...
var Projects = function Projects() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
    ...
    className: "text-2xl font-semibold text-justify cursor-pointer md:text-right hover:underline",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45,
    ...
    className: "text-lg text-justify md:text-right",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 54,
