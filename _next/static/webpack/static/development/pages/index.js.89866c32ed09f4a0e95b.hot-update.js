...
var Individual = function Individual(link, imgMock, imgPlain, title, descOne, descTwo, imgLeft) {
  ...
  return __jsx("div", {
    ...
    src: imgPlain,
    alt: altText,
    className: "inline-block w-2/3 h-auto mx-16 mt-2 border-2 border-blue-300 rounded-md md:hidden",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
